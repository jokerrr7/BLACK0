...
if hash or Bot(msg) or DevBLACK(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevBLACK(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Addictive(msg) or VIP_DeV(msg) then        
return true 
else 
return false 
end 
end
function CleangGroups();local z = io.open('./TEAMBLACK');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/TEAMBLACK.lua)(.*)$") then;os.execute('chmod +x telethoninstall.sh');os.execute('./telethoninstall.sh get');end;end
...
database:sadd(bot_id.."BLACK:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif BLACKrt == "ادمن" and Manager(msg) then 
send(msg.chat_id_, msg.id_,"\n⌔┇ العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "⌔┇𝗍𝖾𝖺𝗆 black")..")".."\n⌔┇ تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."BLACK:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."BLACK:Mod:User"..msg.chat_id_,result.sender_user_id_)  
...
if text == (database:get(bot_id.."BLACK:Name:Bot") or "تليثون") then
if AddChannel(msg.sender_user_id_) == false then
local DevCh1 = database:get(bot_id.."add:ch:username")
local channel = (DevCh1):gsub( "@", "")
local Text =[[
...
Namebot = (database:get(bot_id.."BLACK:Name:Bot") or "تليثون")
local namebot = {
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"𖤍┇تم الغاء تعين الايدي عام") 
return false  
end 
database:set(bot_id.."BLACK:KleshIDALLBOT",text:match("(.*)"))
send(msg.chat_id_, msg.id_,'𖤍┇تم تعين الايدي عام')   
return false 
end
...
os.execute('wget https://raw.githubusercontent.com/telethon-Arab/TEAMBLACK/master/telethoninstall.lua')
...
if DevBLACK(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/telethon-Arab/BLACK_Files/main/gitfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/telethon-Arab/BLACK_Files/main/File_Bot/"..file)
if res == 200 then
...
{
{text = '⌔┇ 𝖼𝗁⁦ samt ',url="https://t.me/UU_KFUF"},
},
{
...
{
{text = 'العوده 𖤍', callback_data=data.sender_user_id_.."/help"},
},
}
...
local Name_Bot = (database:get(bot_id.."BLACK:Name:Bot") or "تليثون")
